...
# Si le fichier fait plus de 1500 lignes, il faut le découper en morceaux, qui seront concatébés une l'opération de géocodage terminé
chunk_by = 1000  # Nombre de lignes de chaque sous-fichier csv.
# Indiquer les colonnes contenant les éléments d'adresses. Pour cibler la requête, si on est sûr du code Insee, on peut contraindre les résultats en précisant "citycode" 
